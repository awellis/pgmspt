...
knitr::include_graphics('diagrams/figure-particle-filter-explained.pdf')
```

\autoref{fig:passive} shows the result of applying the particle filtering algorithm to the graphical model depicted in \autoref{fig:graphical-model-inference}, in order to infer the velocity and position during a two-second leftward head turn.
...
knitr::include_graphics('diagrams/dynamic-belief-network-inference-2.pdf')
```
...
- place the emerging field of vestibular cognition with a framewokk for dynamic probabilistic inference and draw links to established models of sensory processing
