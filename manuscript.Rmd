...
knitr::include_graphics('diagrams/fig-1-common-process.tiff')
```
...
knitr::include_graphics('diagrams/dynamic-belief-network-inference-1.tiff')
```
...
knitr::include_graphics('diagrams/figure-particle-filter-explained.tiff')
```
...
knitr::include_graphics('diagrams/dynamic-belief-network-inference-2.tiff')
```
