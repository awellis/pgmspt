...
```{r head-turn-data, echo=FALSE, fig.cap="Sensory measurements obtained during a short leftward head turn. The goal is to infer the latent angular velocity and position, message=FALSE, warning=FALSE, based on the noisy measurements.", message=FALSE, dpi=100}
dt <- 0.1
...
cowplot::plot_grid(p_3d_1, p_3d_2, ncol = 2, labels = c("a", "b"))
```
